...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url()?>assets/AdminLTE2/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo base_url()?>assets/AdminLTE2/bower_components/data">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url()?>assets/AdminLTE2/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Theme style -->
